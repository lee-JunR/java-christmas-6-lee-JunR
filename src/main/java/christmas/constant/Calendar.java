...
public enum Calendar {
  ...
  DECEMBER_2023(new DayType[]{ DayType.WEEKEND, DayType.WEEKEND,
      DayType.SPECIAL_WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKEND, DayType.WEEKEND,
      DayType.SPECIAL_WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKEND, DayType.WEEKEND,
      DayType.SPECIAL_WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKEND, DayType.WEEKEND,
      DayType.SPECIAL_WEEKDAY, DayType.SPECIAL_WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKDAY, DayType.WEEKEND, DayType.WEEKEND,
      DayType.SPECIAL_WEEKDAY}, // 25일은 특별 할인 날
  ...
  public enum DayType {
    WEEKDAY, // 주중
    WEEKEND, // 주말
    SPECIAL_WEEKDAY, // 특별 할인 + 주중
    SPECIAL_WEEKEND // 특별 할인 + 주말
  }
}
